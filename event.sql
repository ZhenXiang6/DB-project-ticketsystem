...
VALUES 
('宏寬藝術', '(02)6722969'),
('杰爾威音樂有限公司', '(02)7364581'),
('草莓娛樂', '(02)4629406');

SELECT setval('venue_v_id_seq', 30, TRUE);
INSERT INTO VENUE (v_name, address, capacity, contact_info)
VALUES
    ('台北國際會議中心TICC', '台北市信義路五段1號', 3000, '(02)27255200'),
	('Zepp New Taipei', '新北市新莊區新北大道四段3號8樓', 2000, '(02)85228553'),
    ('台北小巨蛋', '台北市南京東路四段2號', 15000, '(02)25783536'),
	('台北大巨蛋', '台北市信義區忠孝東路四段515號', 15000, '(02)27228811'),
    ('高雄展覽館', '高雄市前鎮區成功二路39號', 5000, '(07)12345678'),
    ('台中國家歌劇院', '台中市西屯區惠來路二段101號', 2000, '(04)87654321'),
    ('國父紀念館演藝廳', '台北市忠孝東路四段505號', 1000, '(02)55667788'),
    ('中正紀念堂自由廣場音樂廳', '台北市中正區中山南路21號', 2000, '(02)33445566'),
    ('花蓮文化創意產業園區', '花蓮市中正路99號', 500, '(03)22334455'),
    ('台東藝術中心', '台東市中興路100號', 800, '(08)91234567'),
    ('宜蘭演藝廳', '宜蘭市復興路三段36號', 1200, '(03)77889900'),
    ('新竹文化局演藝廳', '新竹市東區中正路17號', 1500, '(03)11223344'),
	('國立體育大學綜合體育館', '桃園市龜山區文化一路250號', 15000, '(03)3283201'),
